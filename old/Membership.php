...
<head>
	...
	<meta name="description" content="Cal Animage Epsilon is open to everyone in the public.
	But we do offer membership for people who donate to the club." />
		...
		<div id="main_body_container">
			<div id="main_column">
				...
				<table>
					<tr>
						<th>
							<IMG class="centered_images" src="./Images/mem.png">
						</th>
						<th>
							<h1>MEMBERSHIP</h1>
						</th>
				...
				<br/>
				<h2>ABOUT DONATION MEMBERSHIP</h2>
				<p>
					While joining our club and participating in club activities and events is free to everyone in the public,
					at lot of money is required to hold some of our events and maintain our equipment.
					As a result, we rely in funding from our snack bar, as well as donations from our members since we're a non-profit organization.
					Members who donate towards the club will be a part of our Donation Membership, and will give benefits as thanks for the donation.
				</p>
				<p>
					We currently accept two types of donations. A Quarterly Donation pledge, and an Annual Donation pledge.
				</p>
				<p>
					<i>Quarterly Donation</i> costs $6 a quarter.
				</p>
				<p>
					<i>Annual Donation</i> costs $15 a year.
				</p>
				<br/>
				<br/>
				<h2>DONATION MEMBERSHIP BENEFITS</h2>
				<p>
					To say thanks to our members who help donate to the club, we'll offer the following:
					<br/>
						<li>A membership card</li>
						<li>Discounts on our snack bar</li>
						<li>Discounts on club related stuff, such as club T-Shirts</li>
						<li>Entries to a small raffle held for anime figures, manga, posters, etc. held at the end of the Quarter</li>
						<li>Our eternal gratitude, but not our souls</li>
				</p>
				<br/>
				<br/>
				<!-- Main Column End -->
