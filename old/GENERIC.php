...
<div id="main_container">
	...
	<div class="menu">
		<ul>
			...
			<li><a href="Events.php" target="_self" >EVENTS</a>
				<ul>
					<li><a href="Events.php" target="_self">Quarter Events</a></li>
					<li><a href="Calendar.php" target="_self">Event Calendar</a></li>
				</ul>
			</li>
	...
	<div id="right_side_container">
		<div id="main_body_container">
			<div id="main_column">
				<!-- Main Column Code -->
				<IMG class="centered_images" src="./Images/Fall.jpg">
				<p/>
				<h2>WELCOME</h2>
				<p>
				...
				<hr />
				<h3><a href="Spring2012.html" target="_self">Spring 2012 News</a></h3>
				<!-- Main Column End -->
			</div>
