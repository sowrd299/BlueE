...
<link href="<?php echo (isset($this->_rootref['ROOT_PATH'])) ? $this->_rootref['ROOT_PATH'] : ''; ?>highslide/highslide.css" rel="stylesheet" type="text/css" />
<script type="text/javascript">
// <![CDATA[
hs.graphicsDir = '<?php echo (isset($this->_rootref['ROOT_PATH'])) ? $this->_rootref['ROOT_PATH'] : ''; ?>highslide/graphics/';
hs.align = 'center';
