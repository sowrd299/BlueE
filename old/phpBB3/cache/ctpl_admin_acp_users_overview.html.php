...
<dl>
	...
	<dd>[ <a href="<?php echo (isset($this->_rootref['U_WHOIS'])) ? $this->_rootref['U_WHOIS'] : ''; ?>" onclick="popup(this.href, 700, 500, '_whois'); return false;"><?php echo ((isset($this->_rootref['L_WHOIS'])) ? $this->_rootref['L_WHOIS'] : ((isset($user->lang['WHOIS'])) ? $user->lang['WHOIS'] : '{ WHOIS }')); ?></a> ] [ <a href="<?php echo (isset($this->_rootref['U_RECHECK_SPAM'])) ? $this->_rootref['U_RECHECK_SPAM'] : ''; ?>" onclick="popup(this.href, 700, 500, '_whois'); return false;"><?php echo ((isset($this->_rootref['L_RECHECK_SPAM'])) ? $this->_rootref['L_RECHECK_SPAM'] : ((isset($user->lang['RECHECK_SPAM'])) ? $user->lang['RECHECK_SPAM'] : '{ RECHECK_SPAM }')); ?></a> ]</dd>
</dl>
<?php } ?>
				...
				<dl>
					...
					<dd>
						...
						<?php } else { ?>
							...
							<option class="sep" value=""><?php echo ((isset($this->_rootref['L_USER_NO_POSTS_TO_DELETE'])) ? $this->_rootref['L_USER_NO_POSTS_TO_DELETE'] : ((isset($user->lang['USER_NO_POSTS_TO_DELETE'])) ? $user->lang['USER_NO_POSTS_TO_DELETE'] : '{ USER_NO_POSTS_TO_DELETE }')); ?></option>
						<?php } ?>

							<option value="report_spammer"><?php echo ((isset($this->_rootref['L_USER_ADMIN_REPORT_SPAMMER'])) ? $this->_rootref['L_USER_ADMIN_REPORT_SPAMMER'] : ((isset($user->lang['USER_ADMIN_REPORT_SPAMMER'])) ? $user->lang['USER_ADMIN_REPORT_SPAMMER'] : '{ USER_ADMIN_REPORT_SPAMMER }')); ?></option>
						</select>
					</dd>
					</dd>
				</dl>
