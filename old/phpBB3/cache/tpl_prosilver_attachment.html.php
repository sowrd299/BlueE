<?php if (!defined('IN_PHPBB')) exit; $__file_count = (isset($this->_tpldata['_file'])) ? sizeof($this->_tpldata['_file']) : 0;if ($__file_count) {for ($__file_i = 0; $__file_i < $__file_count; ++$__file_i){$__file_val = &$this->_tpldata['_file'][$__file_i]; if ($__file_val['S_DENIED']) {  ?>
	...
	<?php } else { if ($__file_val['S_THUMBNAIL']) {  ?>
		...
		<dl class="thumbnail">
			<dd class="highslide-gallery"><a href="<?php echo $__file_val['U_DOWNLOAD_LINK']; ?>/<?php echo $__file_val['DOWNLOAD_NAME']; ?>" class="highslide" onclick="return hs.expand(this, { slideshowGroup: '<?php echo $__file_val['THUMB_POST_ID']; ?>' })"><img src="<?php echo $__file_val['THUMB_IMAGE']; ?>" alt="<?php echo $__file_val['DOWNLOAD_NAME']; ?>" title="<?php echo $__file_val['DOWNLOAD_NAME']; ?> (<?php echo $__file_val['FILESIZE']; ?> <?php echo $__file_val['SIZE_LANG']; ?>) <?php echo $__file_val['L_DOWNLOAD_COUNT']; ?>" /></a><div class="highslide-caption"><?php echo $__file_val['DOWNLOAD_NAME']; ?> (<?php echo $__file_val['FILESIZE']; ?> <?php echo $__file_val['SIZE_LANG']; ?>) <?php echo $__file_val['L_DOWNLOAD_COUNT']; ?></div></dd>
