...
<fieldset class="fields1">
	...
	<?php } if (! $this->_rootref['S_PRIVMSGS'] && $this->_rootref['S_DISPLAY_EMAIL']) {  ?>

	<dl style="clear: left;">
		<dt><label for="user_email"><?php echo ((isset($this->_rootref['L_EMAIL_ADDRESS'])) ? $this->_rootref['L_EMAIL_ADDRESS'] : ((isset($user->lang['EMAIL_ADDRESS'])) ? $user->lang['EMAIL_ADDRESS'] : '{ EMAIL_ADDRESS }')); ?>:</label></dt>
		<dd><input type="text" tabindex="2" name="user_email" id="user_email" size="25" value="<?php echo (isset($this->_rootref['USER_EMAIL'])) ? $this->_rootref['USER_EMAIL'] : ''; ?>" class="inputbox autowidth" /></dd>
	</dl>
